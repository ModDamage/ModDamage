...
public class DynamicTagInteger extends DynamicInteger
{	
		...
		DynamicInteger.register(
				...
				new DynamicIntegerBuilder()
				{
					...
					public DynamicInteger getNewFromFront(Matcher matcher, StringMatcher sm, EventInfo info)
					{
						...
						return sm.acceptIf(new DynamicTagInteger(
	...
	DynamicTagInteger(DataRef<Entity> entityRef, DataRef<EntityType> entityElementRef, DataRef<World> worldRef, String tag)
	{
