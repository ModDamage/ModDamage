...
public class EnchantmentInt extends IntegerExp
{	
	...
	EnchantmentInt(DataRef<Entity> entityRef, EnchantmentItemSlot itemSlot, Enchantment enchantment)
	{
	...
	EnchantmentInt(DataRef<EnchantmentsRef> enchantmentsRef, Enchantment enchantment)
	{
		this.entityRef = null;
		this.itemSlot = null;
		this.enchantment = enchantment;
