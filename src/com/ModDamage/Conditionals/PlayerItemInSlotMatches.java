...
public class PlayerItemInSlotMatches extends Conditional
{
	...
	public PlayerItemInSlotMatches(String configString, DataRef<Entity> entityRef, DataRef<EntityType> entityElementRef, IntegerExp slot, Collection<ModDamageItemStack> items)
	{
		super(configString);
