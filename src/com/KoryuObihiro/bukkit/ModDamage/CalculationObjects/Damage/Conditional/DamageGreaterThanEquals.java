...
public class DamageGreaterThanEquals extends ConditionalDamageCalculation
{
	final int value;
	public DamageGreaterThanEquals(boolean inverted, int value, List<DamageCalculation> calculations)
	{ 
