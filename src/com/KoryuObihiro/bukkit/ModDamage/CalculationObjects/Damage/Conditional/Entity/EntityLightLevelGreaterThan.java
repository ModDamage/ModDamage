...
public class EntityLightLevelGreaterThan extends EntityConditionaDamageCalculation 
{
	final byte lightLevel;
	public EntityLightLevelGreaterThan(boolean inverted, boolean forAttacker, byte lightLevel, List<DamageCalculation> calculations)
	{ 
