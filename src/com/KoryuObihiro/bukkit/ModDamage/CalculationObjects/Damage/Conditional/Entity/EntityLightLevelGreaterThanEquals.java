...
public class EntityLightLevelGreaterThanEquals extends EntityConditionaDamageCalculation 
{
	final byte lightLevel;
	public EntityLightLevelGreaterThanEquals(boolean inverted, boolean forAttacker, byte lightLevel, List<DamageCalculation> calculations)
	{ 
