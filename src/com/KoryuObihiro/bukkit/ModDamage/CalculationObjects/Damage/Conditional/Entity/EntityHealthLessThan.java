...
public class EntityHealthLessThan extends EntityDamageConditionalCalculation 
{
	int value;
	public EntityHealthLessThan(boolean inverted, boolean forAttacker, int compareTo, List<DamageCalculation> calculations)
	{ 
