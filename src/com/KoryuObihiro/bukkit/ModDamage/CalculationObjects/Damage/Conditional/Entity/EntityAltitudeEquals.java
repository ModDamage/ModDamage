...
public class EntityAltitudeEquals extends EntityDamageConditionalCalculation 
{
	final int altitude;
	public EntityAltitudeEquals(boolean inverted, int altitude, boolean forAttacker, List<DamageCalculation> calculations)
	{ 
