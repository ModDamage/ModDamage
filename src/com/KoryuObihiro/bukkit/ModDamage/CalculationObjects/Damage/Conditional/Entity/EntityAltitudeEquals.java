...
public class EntityAltitudeEquals extends EntityConditionaDamageCalculation 
{
	final int altitude;
	public EntityAltitudeEquals(boolean forAttacker, boolean inverted, int altitude, List<DamageCalculation> calculations)
	{ 
