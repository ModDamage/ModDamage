...
public class EntityAltitudeLessThan extends EntityConditionaDamageCalculation 
{
	final int altitude;
	public EntityAltitudeLessThan(boolean forAttacker, boolean inverted, int altitude, List<DamageCalculation> calculations)
	{ 
