...
public class EntityHealthGreaterThanEquals extends EntityConditionaDamageCalculation 
{
	int value;
	public EntityHealthGreaterThanEquals(boolean inverted, boolean forAttacker, int compareTo, List<DamageCalculation> calculations)
	{ 
