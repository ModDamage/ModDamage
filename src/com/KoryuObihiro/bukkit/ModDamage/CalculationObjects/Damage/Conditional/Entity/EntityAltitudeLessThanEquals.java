...
public class EntityAltitudeLessThanEquals extends EntityConditionaDamageCalculation 
{
	final int altitude;
	public EntityAltitudeLessThanEquals(boolean forAttacker, boolean inverted, int altitude, List<DamageCalculation> calculations)
	{ 
