...
public class EntityAltitudeGreaterThanEquals extends EntityConditionaDamageCalculation 
{
	final int altitude;
	public EntityAltitudeGreaterThanEquals(boolean forAttacker, boolean inverted, int altitude, List<DamageCalculation> calculations)
	{ 
