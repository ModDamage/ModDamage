...
public class EntityAltitudeGreaterThanEquals extends EntityConditionalSpawnCalculation 
{
	final int altitude;
	public EntityAltitudeGreaterThanEquals(boolean inverted, int altitude, List<SpawnCalculation> calculations)
	{ 
