...
public class EntityLightLevelEquals extends EntityConditionalSpawnCalculation 
{
	final byte lightLevel;
	public EntityLightLevelEquals(byte lightLevel, boolean inverted, List<SpawnCalculation> calculations)
	{ 
