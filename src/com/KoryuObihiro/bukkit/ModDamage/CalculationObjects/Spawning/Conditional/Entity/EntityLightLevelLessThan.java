...
public class EntityLightLevelLessThan extends EntityConditionalSpawnCalculation 
{
	final byte lightLevel;
	public EntityLightLevelLessThan(byte lightLevel, boolean inverted, List<SpawnCalculation> calculations)
	{ 
