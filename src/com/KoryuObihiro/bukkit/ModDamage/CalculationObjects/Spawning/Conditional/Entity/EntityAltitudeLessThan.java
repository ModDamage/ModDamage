...
public class EntityAltitudeLessThan extends EntityConditionalSpawnCalculation 
{
	final int altitude;
	public EntityAltitudeLessThan(boolean inverted, int altitude, List<SpawnCalculation> calculations)
	{ 
