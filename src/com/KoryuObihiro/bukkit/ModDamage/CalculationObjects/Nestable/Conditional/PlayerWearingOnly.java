...
public class PlayerWearingOnly extends EntityConditionalCalculation<String>
{
	...
	{
		CalculationUtility.register(PlayerWearingOnly.class, Pattern.compile(CalculationUtility.ifPart + CalculationUtility.entityPart + "wearingonly\\." + CalculationUtility.armorRegex, Pattern.CASE_INSENSITIVE));
	}
}
