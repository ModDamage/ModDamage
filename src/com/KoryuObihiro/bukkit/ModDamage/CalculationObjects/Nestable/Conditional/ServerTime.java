...
public class ServerTime extends ServerConditional
{
	private boolean checkInverse;
	private long beginningTime;
	private long endTime;
	public ServerTime(int beginningTime, int endTime, List<ModDamageCalculation> calculations)
	{
		super(beginningTime > endTime, calculations);
