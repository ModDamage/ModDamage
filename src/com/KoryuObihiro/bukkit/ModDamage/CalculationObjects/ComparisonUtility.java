...
public enum ComparisonUtility
{ 
	EQUALS, NOT_EQUALS, LESS_THAN, LESS_THAN_EQUALS, GREATER_THAN, GREATER_THAN_EQUALS;

	public static ComparisonUtility matchType(String string)
	{
	...
	public static boolean compare(ComparisonUtility comparisonType, int operand_1, int operand_2)
	{
