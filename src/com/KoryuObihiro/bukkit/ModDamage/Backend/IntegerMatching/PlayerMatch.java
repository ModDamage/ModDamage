...
public class PlayerMatch extends IntegerMatch
{
	protected final EntityReference entityReference;
	protected final PlayerPropertyMatch propertyMatch;
	public enum PlayerPropertyMatch
	{
		...
		private PlayerPropertyMatch(){}
		private PlayerPropertyMatch(boolean settable)
		{
			this.settable = settable;
		}
		private PlayerPropertyMatch(boolean settable, boolean usesMcMMO)
		{
			this.settable = settable;
	...
	PlayerMatch(EntityReference reference, PlayerPropertyMatch propertyMatch)
	{
