...
public class EntityTargetedByOther extends EntityConditionalStatement<LivingEntity>
{
	...
	{
		ConditionalRoutine.registerStatement(routineUtility, EntityTargetedByOther.class, Pattern.compile("(!)?" + ModDamage.entityRegex + "\\.targetedbyother", Pattern.CASE_INSENSITIVE));
	}
