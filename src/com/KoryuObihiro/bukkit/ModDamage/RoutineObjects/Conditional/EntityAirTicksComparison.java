	...
	public static EntityAirTicksComparison getNew(Matcher matcher)
	{
		if(matcher != null)
		{
			...
			if(comparisonType != null)
				return new EntityAirTicksComparison(matcher.group(1) != null, (ModDamage.matchesValidEntity(matcher.group(2)))?ModDamage.matchEntity(matcher.group(2)):false, Integer.parseInt(matcher.group(4)), comparisonType);
		}
		return null;
	}
}
